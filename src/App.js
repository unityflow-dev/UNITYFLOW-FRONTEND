...
function VolunteerMainApp({ volunteer, onLogout }) {
  ...
  const incoming = tasks.filter(t => t.status === "open" t.status === "open" && t.sector === volunteer.skills || t.sector === (volunteer.sector)t.status === "open" && t.sector === volunteer.skills || t.sector === (volunteer.sector) (t.sector === volunteer.skills || t.sector === volunteer.sector));
